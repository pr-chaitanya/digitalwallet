...
<html>
    ...
    color:#2E4372;
        ...
        <div class='content_customer'>
            ...
            <p><span class="heading">Instructor : </span>Sangeeta mam</p>
            <p><span class="heading">Contribtors : </span>Ram Chaitanya Polisetty , Rajesh Kadem  , Sanghamitra</p>

            
            <form action="contacting.php" method="POST">
  <table align="center">
            <tr><td><span class="caption">Consult admin</span></td></tr>
            <tr><td colspan="2"><hr></td></tr>
            <tr><td>Your Mobile No.</td>
