...
$result=   mysqli_query($conn,$sql)  or die(mysql_error()); ?>
    ...
    <table align="center">
                        ...
                        while($rws=  mysqli_fetch_assoc($result)){
							...
							echo "<td>"."</td>";
                            echo "<td>".$rws["time"]."</td>";
                            if($rws["Receiver"]==$user) {echo "<td>"."+".$rws["amount"]."</td>"; $other=$rws["Sender"];}else {echo "<td>"." "."</td>"; $other=$rws["Receiver"];}
                            if($rws["Sender"]==$user) echo "<td>"."-".$rws["amount"]."</td>"; else echo "<td>"." "."</td>";
